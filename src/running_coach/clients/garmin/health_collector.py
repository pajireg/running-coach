...
class HealthDataCollector:
    ...
    def collect(self, target_date: date) -> HealthMetrics:
        """건강 지표 수집 (통합)
    ...
    def _get_steps(self, date_str: str) -> Optional[int]:
        ...
        try:
            ...
            raw_steps = stats.get("totalSteps", 0)
    ...
    def _get_resting_hr(self, date_str: str) -> Optional[int]:
        ...
        try:
            ...
            return int(rhr) if rhr is not None else None
        except Exception as e:
    ...
    def _get_body_battery(self, date_str: str) -> Optional[int]:
        ...
        try:
            ...
            return int(bb_val) if bb_val is not None else None
    ...
    def _get_hrv(self, date_str: str) -> Optional[int]:
        ...
        try:
            ...
            if hrv_data and isinstance(hrv_data, dict):
                ...
                return int(hrv_val) if hrv_val is not None else None
            return None
        except Exception as e:
