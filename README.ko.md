...
Running Coach는 Garmin Connect 데이터, Postgres 코칭 히스토리 DB, 그리고 규칙 엔진과 LLM을 결합한 계획 엔진 위에서 동작하는 상시 실행형 적응형 러닝 코치입니다.
...
3. 규칙 엔진이 안전한 주간 skeleton을 만듭니다.
4. LLM이 그 제약 안에서 세션 설명과 워크아웃 디테일을 보정합니다.
