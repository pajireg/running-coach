...
- scheduled workouts are tracked by stored Garmin schedule IDs and workout IDs when possible, so user-facing workout titles can stay short without the `Running Coach:` prefix
