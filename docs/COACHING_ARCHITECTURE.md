...
- the LLM is called only when an active plan is missing, a new activity appeared after the last plan, or a prior planned workout became overdue without a meaningful execution match
